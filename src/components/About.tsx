            ...
            <div className="px-6 md:p-0 grid md:grid-cols-8 gap-6 place-items-center">
                ...
                <div className="w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
                    ...
                    <div className="flex flex-row p-6 relative z-10">
                        <Image src={book} alt="book" className="w-auto h-[130px] mr-6" />
                        <div className="flex flex-col">
                            <h2 className="text-2xl font-bold text-[#005e99]">School</h2>
                ...
                <div className="w-full md:col-span-3 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
                    ...
                    <div className="flex flex-row p-6 relative z-10">
                        <Image src={stress} alt="stress" className="w-auto h-[50px] mt-7 mr-6" />
                        <div className="flex flex-col">
                            <h2 className="text-2xl font-bold text-[#005e99]">My Research</h2>
                            <p className="text-lg text-black/90 mt-4">
                ...
                <div className="w-full md:col-span-3 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
                    ...
                    <div className="flex flex-row p-6 relative z-10">
                        <Image src={card} alt="card" className="w-auto h-[130px] mr-6" />
                        <div className="flex flex-col">
                            <h2 className="text-2xl font-bold text-[#005e99]">Experience</h2>
                            <p className="text-lg text-black/90 mt-2">
                ...
                <div className="w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
                    ...
                    <div className="flex flex-row p-6 relative z-10">
                        <Image src={pc} alt="pc" className="w-auto h-[130px] mr-6" />
                        <div className="flex flex-col">
                            <h2 className="text-2xl font-bold text-[#005e99]">Technical Skills</h2>
                            <p className="text-lg text-black/90 mt-2">
